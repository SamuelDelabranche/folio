...
abstract class AppLocalizations {
  ...
  /// No description provided for @addCustomGenre.
  ///
  /// In fr, this message translates to:
  /// **'Ajouter un genre'**
  String get addCustomGenre;

  /// No description provided for @addCustomType.
  ///
  /// In fr, this message translates to:
  /// **'Ajouter un type'**
  String get addCustomType;

  /// No description provided for @addCustomDeleteTitle.
  ///
  /// In fr, this message translates to:
  /// **'Supprimer ce type ?'**
  String get addCustomDeleteTitle;
  ...
  /// No description provided for @settingsImportWarningTags.
  ///
  /// In fr, this message translates to:
  ...
  ///
  /// In fr, this message translates to:
  /// **'github.com/SamuelDelabranche/folio/issues'**
  ...
  /// No description provided for @genreGame.
  ///
  /// In fr, this message translates to:
  /// **'Jeux'**
  String get genreGame;
  ...
  /// No description provided for @genreKodomomuke.
  ///
  /// In fr, this message translates to:
  /// **'Kodomomuke'**
  String get genreKodomomuke;
  ...
  /// No description provided for @genreGore.
  ///
  /// In fr, this message translates to:
  /// **'Gore'**
  String get genreGore;

  /// No description provided for @genreMilitary.
  ///
  /// In fr, this message translates to:
  /// **'Militaire'**
  String get genreMilitary;

  /// No description provided for @genrePolitics.
  ///
  /// In fr, this message translates to:
  /// **'Politique'**
  String get genrePolitics;
